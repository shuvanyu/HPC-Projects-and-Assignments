...
//
  ...
  {
    x[i] = i;
    x[i+5] = 0;                         /*** The error was mainly due to uninitialized values of x[5] to x[9]. 
                                         Since the initialization loop is defined 0 to 5, I initialized the remaining with zero ***/
  }
//
//  Copy some values.
